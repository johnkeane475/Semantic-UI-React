...
function (_Component) {
  ...
  function Visibility() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "update", function () {
      ...
      _this.pageYOffset = _this.props.context ? _this.props.context.scrollTop : window.pageYOffset;
  ...
  (0, _createClass2.default)(Visibility, [{
    ...
    value: function computeCalculations() {
      ...
      var newOffset = this.props.context ? this.props.context.scrollTop : window.pageYOffset;
